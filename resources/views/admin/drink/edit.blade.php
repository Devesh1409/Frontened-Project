...
@section('tittle','Drink | edit Drink')
@section('content')
 <!-- Content Wrapper. Contains page content -->
  ...
  <div class="content-wrapper">
    ...
    @endif -->
    <form class="form-group" method="post" action="{{url('drink/update')}}" enctype="multipart/form-data">
                      @csrf
                    ...
                    <br><br>
                     ...
                     <input type="text" name="rate" required="required" placeholder="ENTER 
                              RATE" class="form-control" value="{{$data->rate}}">
                    <br><br>
                    Image:

...
@section('tittle','Lunch | Add Lunch')
@section('content')
     ...
     <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title">Lunch</h3>
                 <div class="ml-auto">
                  <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#aa">Add Lunch</button>
                  ...
                  <tbody>
                    ...
                    <td> <img src="/upload/{{$a->image}}" style="width: 100px;height: 100px;"></td>
                     ...
                     <td>
                      ...
                      <a href="{{url('admin/lunch/edit/'.$a->id)}}">Edit</a>
                      <a href="{{url('lunch/delete/'.$a->id)}}">Delete</a>
                    </td>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{url('lunch/insert')}}" enctype="multipart/form-data" >
                        @csrf
                        <div class="card">
                          @if ($errors->any())
